...
import app.kaidonav.background.OsmUploadWork;
import app.kaidonav.bookmarks.data.BookmarkManager;
import app.kaidonav.display.DisplayManager;
import app.kaidonav.downloader.Android7RootCertificateWorkaround;
import app.kaidonav.downloader.DownloaderNotifier;
...
import app.kaidonav.settings.StoragePathManager;
import app.kaidonav.sound.TtsPlayer;
import app.kaidonav.util.Config;
import app.kaidonav.util.ConnectionState;
import app.kaidonav.util.SharedPropertiesUtils;
...
import app.kaidonav.util.log.LogsManager;
...
public class MwmApplication extends Application implements Application.ActivityLifecycleCallbacks
{
  ...
  private void initNativePlatform() throws IOException
  {
    ...
    nativeInitPlatform(getApplicationContext(),
                       ...
                       privatePath,
                       tempPath,
                       app.kaidonav.BuildConfig.FLAVOR,
                       app.kaidonav.BuildConfig.BUILD_TYPE, UiUtils.isTablet(this));
