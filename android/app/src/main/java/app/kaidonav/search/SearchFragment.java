...
import app.kaidonav.downloader.CountrySuggestFragment;
...
import app.kaidonav.sdk.search.SearchListener;
import app.kaidonav.sdk.search.SearchRecents;
import app.kaidonav.sdk.search.SearchResult;
  ...
  void showAllResultsOnMap()
  {
    ...
    SearchEngine.INSTANCE.searchInteractive(
        query, isCategory(), !TextUtils.isEmpty(mInitialLocale)
               ? mInitialLocale : app.kaidonav.util.Language.getKeyboardLocale(requireContext()),
