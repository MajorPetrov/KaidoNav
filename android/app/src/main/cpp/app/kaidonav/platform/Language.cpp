...
#include "android/app/src/main/cpp/app/kaidonav/core/ScopedLocalRef.hpp"
...
std::string GetAndroidSystemLanguage()
{
  ...
  static jclass const languageClass = jni::GetGlobalClassRef(env, "app/kaidonav/util/Language");
