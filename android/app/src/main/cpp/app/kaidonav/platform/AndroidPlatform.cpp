...
std::string Platform::GetMemoryInfo() const
{
  ...
  static std::shared_ptr<jobject> classLogsManager = jni::make_global_ref(env->FindClass("app/kaidonav/util/log/LogsManager"));
...
Platform::EConnectionType Platform::ConnectionStatus()
{
  ...
  static std::shared_ptr<jobject> clazzConnectionState = jni::make_global_ref(env->FindClass("app/kaidonav/util/ConnectionState"));
...
Platform::ChargingStatus Platform::GetChargingStatus()
{
  ...
  static jclass const clazzBatteryState =
      jni::GetGlobalClassRef(env, "app/kaidonav/util/BatteryState");
...
void Platform::AndroidSecureStorage::Init(JNIEnv * env)
{
  ...
  m_secureStorageClass = jni::GetGlobalClassRef(env, "app/kaidonav/util/SecureStorage");
