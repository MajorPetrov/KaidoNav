...
public:
             ...
             std::string const & pb)
  {
    ...
    static jclass const klass = jni::GetGlobalClassRef(env, "app/kaidonav/downloader/ChunkTask");
    m_klass = klass;
...
Java_app_kaidonav_downloader_ChunkTask_nativeOnWrite(JNIEnv * env, jclass clazz, jlong httpCallbackID, jlong beg, jbyteArray data, jlong size)
{
...
Java_app_kaidonav_downloader_ChunkTask_nativeOnFinish(JNIEnv * env, jclass clazz, jlong httpCallbackID, jlong httpCode, jlong beg, jlong end)
{
  downloader::IHttpThreadCallback * cb = reinterpret_cast<downloader::IHttpThreadCallback*>(httpCallbackID);
