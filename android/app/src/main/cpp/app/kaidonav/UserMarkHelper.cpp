...
//    jni::GetGlobalClassRef(env, "app/kaidonav/sdk/search/Popularity");
                        ...
                        jobject const & routingPointInfo, jobject const & popularity, jobjectArray jrawTypes)
{
  ...
  static jmethodID const ctorId = jni::GetConstructorID(
      ...
      "("
      "Lapp/kaidonav/bookmarks/data/FeatureId;" // featureId
      "I"                                               // mapObjectType
      ...
      "Lapp/kaidonav/routing/RoutePointInfo;"   // routePointInfo
      "I"                                               // openingMode
      "Lapp/kaidonav/sdk/search/Popularity;"         // popularity
                       ...
                       jobject const & popularity)
{
  ...
  static jmethodID const ctorId =
          jni::GetConstructorID(env, g_bookmarkClazz,
                                "(Lapp/kaidonav/bookmarks/data/FeatureId;JJLjava/lang/String;"
                                "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;"
                                "Lapp/kaidonav/routing/RoutePointInfo;"
                                "ILapp/kaidonav/sdk/search/Popularity;Ljava/lang/String;"
                                "[Ljava/lang/String;)V");
  static jmethodID const featureCtorId =
          jni::GetConstructorID(env, g_featureIdClazz, "(Ljava/lang/String;JI)V");
...
jobject CreateElevationPoint(JNIEnv * env, ElevationInfo::Point const & point)
{
  static jclass const pointClass =
      jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/ElevationInfo$Point");
...
jobject CreateElevationInfo(JNIEnv * env, ElevationInfo const & info)
{
  ...
  static jmethodID const ctorId =
      jni::GetConstructorID(env, g_elevationInfoClazz, "(JLjava/lang/String;Ljava/lang/String;"
                                                       "[Lapp/kaidonav/bookmarks/data/ElevationInfo$Point;"
                                                       "IIIIIJ)V");
  jni::TScopedLocalObjectArrayRef jPoints(env, ToElevationPointArray(env, info.GetPoints()));
  // TODO (KK): elevation info should have only the elevation data - see the https://github.com/kaidonav/kaidonav/pull/10063
...
{
  static jclass const clazz = jni::GetGlobalClassRef(env, "app/kaidonav/routing/RoutePointInfo");
