...
#include "app/kaidonav/UserMarkHelper.hpp"
#include "app/kaidonav/opengl/androidoglcontextfactory.hpp"
#include "app/kaidonav/platform/AndroidPlatform.hpp"
#include "app/kaidonav/util/Distance.hpp"
#include "app/kaidonav/util/FeatureIdBuilder.hpp"
#include "app/kaidonav/util/NetworkPolicy.hpp"
#include "app/kaidonav/vulkan/android_vulkan_context_factory.hpp"
...
//============ GLUE CODE for app.kaidonav.Framework class =============//
/*            ____
 *          _ |||| _
 *          \\    //
 *           \\  //
...
Java_app_kaidonav_Framework_nativeGetAddress(JNIEnv * env, jclass clazz, jdouble lat, jdouble lon)
{
...
Java_app_kaidonav_Framework_nativeClearApiPoints(JNIEnv * env, jclass clazz)
{
  frm()->GetBookmarkManager().GetEditSession().ClearGroup(UserMark::Type::API);
}

JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeParseAndSetApiUrl(JNIEnv * env, jclass clazz, jstring url)
{
  return static_cast<jint>(frm()->ParseAndSetApiURL(jni::ToNativeString(env, url)));
}

JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetParsedRoutingData(JNIEnv * env, jclass clazz)
{
  using namespace url_scheme;
  static jclass const pointClazz = jni::GetGlobalClassRef(env, "app/kaidonav/api/RoutePoint");
  ...
  static jclass const routeDataClazz = jni::GetGlobalClassRef(env, "app/kaidonav/api/ParsedRoutingData");
  // Java signature : ParsedRoutingData(RoutePoint[] points, int routerType) {
  static jmethodID const routeDataConstructor = jni::GetConstructorID(env, routeDataClazz, "([Lapp/kaidonav/api/RoutePoint;I)V");
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetParsedSearchRequest(JNIEnv * env, jclass clazz)
{
  using namespace url_scheme;
  static jclass const cl = jni::GetGlobalClassRef(env, "app/kaidonav/api/ParsedSearchRequest");
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetParsedAppName(JNIEnv * env, jclass)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetParsedOAuth2Code(JNIEnv * env, jclass)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetParsedBackUrl(JNIEnv * env, jclass)
{
...
Java_app_kaidonav_Framework_nativeGetParsedCenterLatLon(JNIEnv * env, jclass)
{
  ms::LatLon const center = frm()->GetParsedCenterLatLon();
  if (!center.IsValid())
    return nullptr;
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativePlacePageActivationListener(JNIEnv *env, jclass, jobject jListener)
{
  ...
  jmethodID const activatedId = jni::GetMethodID(env, g_placePageActivationListener,
                                                 ...
                                                 "(Lapp/kaidonav/widget/placepage/PlacePageData;)V");
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeRemovePlacePageActivationListener(JNIEnv *env, jclass, jobject jListener)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetGe0Url(JNIEnv * env, jclass, jdouble lat, jdouble lon, jdouble zoomLevel, jstring name)
{
  ::Framework * fr = frm();
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetGeoUri(JNIEnv * env, jclass, jdouble lat, jdouble lon, jdouble zoomLevel, jstring name)
{
  ::Framework * fr = frm();
  double const scale = (zoomLevel > 0 ? zoomLevel : fr->GetDrawScale());
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetDistanceAndAzimuth(
    JNIEnv * env, jclass, jdouble merX, jdouble merY, jdouble cLat, jdouble cLon, jdouble north)
{
  ...
  static jclass const daClazz = jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/DistanceAndAzimut");
  // Java signature : DistanceAndAzimut(Distance distance, double azimuth)
  static jmethodID const methodID = jni::GetConstructorID(env, daClazz, "(Lapp/kaidonav/util/Distance;D)V");
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetDistanceAndAzimuthFromLatLon(
    JNIEnv * env, jclass clazz, jdouble lat, jdouble lon, jdouble cLat, jdouble cLon, jdouble north)
{
  ...
  return Java_app_kaidonav_Framework_nativeGetDistanceAndAzimuth(env, clazz, merX, merY, cLat, cLon, north);
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeFormatLatLon(JNIEnv * env, jclass, jdouble lat, jdouble lon, int coordsFormat)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeFormatAltitude(JNIEnv * env, jclass, jdouble alt)
{
  return jni::ToJavaString(env, platform::Distance::FormatAltitude(alt));
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeFormatSpeed(JNIEnv * env, jclass, jdouble speed)
{
...
/*
JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetOutdatedCountriesString(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, g_framework->GetOutdatedCountriesString());
}

JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_Framework_nativeGetOutdatedCountries(JNIEnv * env, jclass)
{
  vector<Country const *> countries;
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeToDoAfterUpdate(JNIEnv * env, jclass)
{
  return g_framework->ToDoAfterUpdate();
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsDataVersionChanged(JNIEnv * env, jclass)
{
  return frm()->IsDataVersionUpdated() ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeUpdateSavedDataVersion(JNIEnv * env, jclass)
{
...
Java_app_kaidonav_Framework_nativeGetDataVersion(JNIEnv * env, jclass)
{
  return frm()->GetCurrentDataVersion();
}

JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetDrawScale(JNIEnv * env, jclass)
{
  return static_cast<jint>(frm()->GetDrawScale());
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativePokeSearchInViewport(JNIEnv * env, jclass)
{
  frm()->GetSearchAPI().PokeSearchInViewport();
}

JNIEXPORT jdoubleArray JNICALL
Java_app_kaidonav_Framework_nativeGetScreenRectCenter(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeShowTrackRect(JNIEnv * env, jclass, jlong track)
{
  frm()->ShowTrack(static_cast<kml::TrackId>(track));
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetBookmarkDir(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().SettingsDir().c_str());
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetWritableDir(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().WritableDir().c_str());
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetSettingsDir(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, GetPlatform().SettingsDir().c_str());
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetDataFileExt(JNIEnv * env, jclass)
{
  return jni::ToJavaString(env, DATA_FILE_EXTENSION);
}

JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_Framework_nativeGetMovableFilesExts(JNIEnv * env, jclass)
{
...
JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_Framework_nativeGetBookmarksFilesExts(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeChangeWritableDir(JNIEnv * env, jclass, jstring jNewPath)
{
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsRoutingActive(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRoutingActive();
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsRouteBuilding(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRouteBuilding();
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsRouteBuilt(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRouteBuilt();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeCloseRouting(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().CloseRouting(true /* remove route points */);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeBuildRoute(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().BuildRoute();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeRemoveRoute(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().RemoveRoute(false /* deactivateFollowing */);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeFollowRoute(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().FollowRoute();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeDisableFollowing(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().DisableFollowMode();
}

JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_Framework_nativeGenerateNotifications(JNIEnv * env, jclass, bool announceStreets)
{
  ::Framework * fr = frm();
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetSpeedCamManagerMode(JNIEnv * env, jclass, jint mode)
{
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetSpeedCamManagerMode(JNIEnv * env, jclass)
{
  return static_cast<jint>(frm()->GetRoutingManager().GetSpeedCamManager().GetMode());
}

JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetRouteFollowingInfo(JNIEnv * env, jclass)
{
  ::Framework * fr = frm();
  if (!fr->GetRoutingManager().IsRoutingActive())
    return nullptr;
  ...
  static jclass const klass = jni::GetGlobalClassRef(env, "app/kaidonav/routing/RoutingInfo");
  ...
  static jmethodID const ctorRouteInfoID =
      jni::GetConstructorID(env, klass,
                            "(Lapp/kaidonav/util/Distance;Lapp/kaidonav/util/Distance;"
                            "Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;DIIIII"
                            "[Lapp/kaidonav/routing/SingleLaneInfo;DZZ)V");

  vector<routing::FollowingInfo::SingleLaneInfoClient> const & lanes = info.m_lanes;
  jobjectArray jLanes = nullptr;
  if (!lanes.empty())
  {
    static jclass const laneClass = jni::GetGlobalClassRef(env, "app/kaidonav/routing/SingleLaneInfo");
...
JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_Framework_nativeGetRouteJunctionPoints(JNIEnv * env, jclass)
{
  ...
  static jclass const junctionClazz = jni::GetGlobalClassRef(env, "app/kaidonav/routing/JunctionInfo");
...
Java_app_kaidonav_Framework_nativeGenerateRouteAltitudeChartBits(JNIEnv * env, jclass, jint width, jint height, jobject routeAltitudeLimits)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeShowCountry(JNIEnv * env, jclass, jstring countryId, jboolean zoomToDownloadButton)
{
  g_framework->ShowNode(jni::ToNativeString(env, countryId), (bool) zoomToDownloadButton);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetRoutingListener(JNIEnv * env, jclass, jobject listener)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetRouteProgressListener(JNIEnv * env, jclass, jobject listener)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetRoutingRecommendationListener(JNIEnv * env, jclass,
                                                                          jobject listener)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetRoutingLoadPointsListener(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeDeactivatePopup(JNIEnv * env, jclass)
{
  return g_framework->DeactivatePopup();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeDeactivateMapSelectionCircle(JNIEnv * env, jclass)
{
  return g_framework->DeactivateMapSelectionCircle();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetMapStyle(JNIEnv * env, jclass, jint mapStyle)
{
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetMapStyle(JNIEnv * env, jclass)
{
  return g_framework->GetMapStyle();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeMarkMapStyle(JNIEnv * env, jclass, jint mapStyle)
{
  MapStyle const val = static_cast<MapStyle>(mapStyle);
  if (val != g_framework->GetMapStyle())
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetRouter(JNIEnv * env, jclass, jint routerType)
{
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetRouter(JNIEnv * env, jclass)
{
  return static_cast<jint>(g_framework->GetRoutingManager().GetRouter());
}

JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetLastUsedRouter(JNIEnv * env, jclass)
{
  return static_cast<jint>(g_framework->GetRoutingManager().GetLastUsedRouter());
}

JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetBestRouter(JNIEnv * env, jclass,
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeAddRoutePoint(JNIEnv * env, jclass, jstring title,
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeRemoveRoutePoints(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().RemoveRoutePoints();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeRemoveRoutePoint(JNIEnv * env, jclass,
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeRemoveIntermediateRoutePoints(JNIEnv * env, jclass)
{
  frm()->GetRoutingManager().RemoveIntermediateRoutePoints();
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeCouldAddIntermediatePoint(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().CouldAddIntermediatePoint();
}

JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_Framework_nativeGetRoutePoints(JNIEnv * env, jclass)
{
  auto const points = frm()->GetRoutingManager().GetRoutePoints();

  static jclass const pointClazz = jni::GetGlobalClassRef(env,
                                   "app/kaidonav/routing/RouteMarkData");
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeMoveRoutePoint(JNIEnv * env, jclass,
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetTransitRouteInfo(JNIEnv * env, jclass)
{
  ...
  static jclass const transitStepClass = jni::GetGlobalClassRef(env,
                                         "app/kaidonav/routing/TransitStepInfo");
  ...
  static jclass const transitRouteInfoClass = jni::GetGlobalClassRef(env,
                                                                     "app/kaidonav/routing/TransitRouteInfo");
  ...
  static jmethodID const transitRouteInfoConstructor = jni::GetConstructorID(env, transitRouteInfoClass,
                                                                             ...
                                                                             "Ljava/lang/String;Ljava/lang/String;I"
                                                                             "[Lapp/kaidonav/routing/TransitStepInfo;)V");
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeReloadWorldMaps(JNIEnv * env, jclass)
{
  g_framework->ReloadWorldMaps();
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsDayTime(JNIEnv * env, jclass, jlong utcTimeSeconds, jdouble lat, jdouble lon)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSet3dMode(JNIEnv * env, jclass, jboolean allow, jboolean allowBuildings)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeGet3dMode(JNIEnv * env, jclass, jobject result)
{
  bool enabled;
  bool buildings;
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetAutoZoomEnabled(JNIEnv * env, jclass, jboolean enabled)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetTransitSchemeEnabled(JNIEnv * env, jclass, jboolean enabled)
{
  frm()->GetTransitManager().EnableTransitSchemeMode(static_cast<bool>(enabled));
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsTransitSchemeEnabled(JNIEnv * env, jclass)
{
  return static_cast<jboolean>(frm()->LoadTransitSchemeEnabled());
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetIsolinesLayerEnabled(JNIEnv * env, jclass, jboolean enabled)
{
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsIsolinesLayerEnabled(JNIEnv * env, jclass)
{
  return static_cast<jboolean>(frm()->LoadIsolinesEnabled());
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetOutdoorsLayerEnabled(JNIEnv * env, jclass, jboolean enabled)
{
  frm()->SaveOutdoorsEnabled(enabled);
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsOutdoorsLayerEnabled(JNIEnv * env, jclass)
{
  return static_cast<jboolean>(frm()->LoadOutdoorsEnabled());
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSaveSettingSchemeEnabled(JNIEnv * env, jclass, jboolean enabled)
{
  frm()->SaveTransitSchemeEnabled(static_cast<bool>(enabled));
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeGetAutoZoomEnabled(JNIEnv *, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeZoomToPoint(JNIEnv * env, jclass, jdouble lat, jdouble lon, jint zoom, jboolean animate)
{
  g_framework->Scale(m2::PointD(mercator::FromLatLon(lat, lon)), zoom, animate);
}

JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeDeleteBookmarkFromMapObject(JNIEnv * env, jclass)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetPoiContactUrl(JNIEnv *env, jclass, jint id)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetChoosePositionMode(JNIEnv *, jclass, jint mode, jboolean isBusiness,
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetChoosePositionMode(JNIEnv *, jclass)
{
  return static_cast<jint>(g_framework->GetChoosePositionMode());
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsDownloadedMapAtScreenCenter(JNIEnv *, jclass)
{
  ::Framework * fr = frm();
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetActiveObjectFormattedCuisine(JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetVisibleRect(JNIEnv * env, jclass, jint left, jint top, jint right, jint bottom)
{
  frm()->SetVisibleViewport(m2::RectD(left, top, right, bottom));
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeIsRouteFinished(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().IsRouteFinished();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeRunFirstLaunchAnimation(JNIEnv * env, jclass)
{
  frm()->RunFirstLaunchAnimation();
}

JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeOpenRoutePointsTransaction(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().OpenRoutePointsTransaction();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeApplyRoutePointsTransaction(JNIEnv * env, jclass,
                                                                     jint transactionId)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeCancelRoutePointsTransaction(JNIEnv * env, jclass,
                                                                      jint transactionId)
{
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeInvalidRoutePointsTransactionId(JNIEnv * env, jclass)
{
  return frm()->GetRoutingManager().InvalidRoutePointsTransactionId();
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeHasSavedRoutePoints(JNIEnv *, jclass)
{
  return frm()->GetRoutingManager().HasSavedRoutePoints();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeLoadRoutePoints(JNIEnv *, jclass)
{
  frm()->GetRoutingManager().LoadRoutePoints(g_loadRouteHandler);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSaveRoutePoints(JNIEnv *, jclass)
{
  frm()->GetRoutingManager().SaveRoutePoints();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeDeleteSavedRoutePoints(JNIEnv *, jclass)
{
  frm()->GetRoutingManager().DeleteSavedRoutePoints();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeShowFeature(JNIEnv * env, jclass, jobject featureId)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeMakeCrash(JNIEnv *env, jclass type)
{
  CHECK(false, ("Diagnostic native crash!"));
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetPowerManagerFacility(JNIEnv *, jclass,
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_Framework_nativeGetPowerManagerScheme(JNIEnv *, jclass)
{
  return static_cast<jint>(frm()->GetPowerManager().GetScheme());
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetPowerManagerScheme(JNIEnv *, jclass, jint schemeType)
{
  frm()->GetPowerManager().SetScheme(static_cast<power_management::Scheme>(schemeType));
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetViewportCenter(JNIEnv *, jclass, jdouble lat, jdouble lon, jint zoom)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeStopLocationFollow(JNIEnv *, jclass)
{
  frm()->StopLocationFollow();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeSetSearchViewport(JNIEnv *, jclass, jdouble lat,
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeHasPlacePageInfo(JNIEnv *, jclass)
{
  return static_cast<jboolean>(frm()->HasPlacePageInfo());
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeMemoryWarning(JNIEnv *, jclass)
{
  return frm()->MemoryWarning();
}

JNIEXPORT jstring JNICALL
Java_app_kaidonav_Framework_nativeGetKayakHotelLink(JNIEnv * env, jclass, jstring countryIsoCode, jstring uri,
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Framework_nativeShouldShowProducts(JNIEnv * env, jclass)
{
  return frm()->ShouldShowProducts();
}

JNIEXPORT jobject JNICALL
Java_app_kaidonav_Framework_nativeGetProductsConfiguration(JNIEnv * env, jclass)
{
  ...
  static jclass const productsConfigClass = jni::GetGlobalClassRef(
    env,
    "app/kaidonav/products/ProductsConfig"
  );
  static jmethodID const productsConfigConstructor = jni::GetConstructorID(
    env,
    productsConfigClass,
    "(Ljava/lang/String;[Lapp/kaidonav/products/Product;)V"
  );
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeDidCloseProductsPopup(JNIEnv * env, jclass, jstring reason)
{
  frm()->DidCloseProductsPopup(frm()->FromString(jni::ToNativeString(env, reason)));
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Framework_nativeDidSelectProduct(JNIEnv * env, jclass, jstring title, jstring link)
{
