...
Java_app_kaidonav_editor_OpeningHours_nativeInit(JNIEnv * env, jclass clazz)
{
  g_clazzHoursMinutes = jni::GetGlobalClassRef(env, "app/kaidonav/editor/data/HoursMinutes");
  ...
  g_clazzTimespan = jni::GetGlobalClassRef(env, "app/kaidonav/editor/data/Timespan");
  // Java signature : Timespan(HoursMinutes start, HoursMinutes end)
  g_ctorTimespan =
      env->GetMethodID(g_clazzTimespan, "<init>","(Lapp/kaidonav/editor/data/HoursMinutes;Lapp/kaidonav/editor/data/HoursMinutes;)V");
  ASSERT(g_ctorTimespan, (jni::DescribeException()));
  g_fidStart = env->GetFieldID(g_clazzTimespan, "start", "Lapp/kaidonav/editor/data/HoursMinutes;");
  ASSERT(g_fidStart, (jni::DescribeException()));
  g_fidEnd = env->GetFieldID(g_clazzTimespan, "end", "Lapp/kaidonav/editor/data/HoursMinutes;");
  ASSERT(g_fidEnd, (jni::DescribeException()));

  g_clazzTimetable = jni::GetGlobalClassRef(env, "app/kaidonav/editor/data/Timetable");
  // Java signature : Timetable(Timespan workingTime, Timespan[] closedHours, boolean isFullday, int weekdays[])
  g_ctorTimetable =
      env->GetMethodID(g_clazzTimetable, "<init>","(Lapp/kaidonav/editor/data/Timespan;[Lapp/kaidonav/editor/data/Timespan;Z[I)V");
  ASSERT(g_ctorTimetable, (jni::DescribeException()));
  g_fidWorkingTimespan = env->GetFieldID(g_clazzTimetable, "workingTimespan", "Lapp/kaidonav/editor/data/Timespan;");
  ASSERT(g_fidWorkingTimespan, (jni::DescribeException()));
  g_fidClosedTimespans = env->GetFieldID(g_clazzTimetable, "closedTimespans", "[Lapp/kaidonav/editor/data/Timespan;");
...
Java_app_kaidonav_editor_OpeningHours_nativeGetDefaultTimetables(JNIEnv * env, jclass clazz)
{
  TimeTableSet tts;
...
Java_app_kaidonav_editor_OpeningHours_nativeGetComplementTimetable(JNIEnv * env, jclass clazz, jobjectArray timetables)
{
...
JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeRemoveWorkingDay(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeAddWorkingDay(JNIEnv * env, jclass clazz,
                                                             jobjectArray timetables, jint ttIndex, jint dayIndex)
{
  TimeTableSet tts = NativeTimetableSet(env, timetables);
  auto tt = tts.Get(ttIndex);
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeSetIsFullday(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeSetOpeningTime(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeAddClosedSpan(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeRemoveClosedSpan(JNIEnv * env, jclass clazz,
...
JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_editor_OpeningHours_nativeTimetablesFromString(JNIEnv * env, jclass clazz, jstring jSource)
{
  TimeTableSet tts;
...
Java_app_kaidonav_editor_OpeningHours_nativeTimetablesToString(JNIEnv * env, jclass clazz, jobjectArray jTts)
{
...
Java_app_kaidonav_editor_OpeningHours_nativeIsTimetableStringValid(JNIEnv * env, jclass clazz, jstring jSource)
{
