...
extern "C"
{
  ...
  Java_app_kaidonav_DownloadResourcesLegacyActivity_nativeGetBytesToDownload(JNIEnv * env, jclass clazz)
  {
    // clear all
  ...
  JNIEXPORT jint JNICALL
  Java_app_kaidonav_DownloadResourcesLegacyActivity_nativeStartNextFileDownload(JNIEnv * env, jclass clazz, jobject listener)
  {
  ...
  Java_app_kaidonav_DownloadResourcesLegacyActivity_nativeCancelCurrentFile(JNIEnv * env, jclass clazz)
  {
