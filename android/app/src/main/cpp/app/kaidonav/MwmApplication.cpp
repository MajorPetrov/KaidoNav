...
extern "C"
{
  ...
  Java_app_kaidonav_MwmApplication_nativeSetSettingsDir(JNIEnv * env, jclass clazz, jstring settingsPath)
  {
  ...
  JNIEXPORT void JNICALL
  Java_app_kaidonav_MwmApplication_nativeInitPlatform(JNIEnv * env, jclass clazz, jobject context,
  ...
  JNIEXPORT void JNICALL
  Java_app_kaidonav_MwmApplication_nativeInitFramework(JNIEnv * env, jclass clazz, jobject onComplete)
  {
    if (!g_framework)
    {
  ...
  JNIEXPORT void JNICALL
  Java_app_kaidonav_MwmApplication_nativeAddLocalization(JNIEnv * env, jclass clazz, jstring name, jstring value)
  {
  ...
  JNIEXPORT void JNICALL
  Java_app_kaidonav_MwmApplication_nativeOnTransit(JNIEnv *, jclass, jboolean foreground)
  {
