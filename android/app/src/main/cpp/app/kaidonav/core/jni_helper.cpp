...
JNI_OnLoad(JavaVM * jvm, void *)
{
  ...
  g_mapObjectClazz = jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/MapObject");
  g_featureIdClazz = jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/FeatureId");
  g_bookmarkClazz = jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/Bookmark");
  g_httpClientClazz = jni::GetGlobalClassRef(env, "app/kaidonav/util/HttpClient");
  g_httpParamsClazz = jni::GetGlobalClassRef(env, "app/kaidonav/util/HttpClient$Params");
  g_platformSocketClazz = jni::GetGlobalClassRef(env, "app/kaidonav/location/PlatformSocket");
  g_utilsClazz = jni::GetGlobalClassRef(env, "app/kaidonav/util/Utils");
  g_loggerClazz = jni::GetGlobalClassRef(env, "app/kaidonav/util/log/Logger");
  g_keyValueClazz = jni::GetGlobalClassRef(env, "app/kaidonav/util/KeyValue");
  g_networkPolicyClazz = jni::GetGlobalClassRef(env, "app/kaidonav/util/NetworkPolicy");
  g_elevationInfoClazz = jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/ElevationInfo");
...
{
  jclass klass = env->FindClass("app/kaidonav/bookmarks/data/ParcelablePointD");
  ASSERT ( klass, () );
