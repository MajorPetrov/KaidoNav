...
Java_app_kaidonav_Map_nativeCreateEngine(JNIEnv * env, jclass,
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Map_nativeIsEngineCreated(JNIEnv *, jclass)
{
  return g_framework->IsDrapeEngineCreated();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeUpdateEngineDpi(JNIEnv *, jclass, jint dpi)
{
  return g_framework->UpdateDpi(dpi);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeExecuteMapApiRequest(JNIEnv * env, jclass)
{
  return g_framework->ExecuteMapApiRequest();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeSetRenderingInitializationFinishedListener(
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Map_nativeAttachSurface(JNIEnv * env, jclass, jobject surface)
{
  return g_framework->AttachSurface(env, surface);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeDetachSurface(JNIEnv *, jclass, jboolean destroySurface)
{
  g_framework->DetachSurface(destroySurface);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeSurfaceChanged(JNIEnv * env, jclass, jobject surface, jint w, jint h)
{
  g_framework->Resize(env, surface, w, h);
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_Map_nativeDestroySurfaceOnDetach(JNIEnv *, jclass)
{
  return g_framework->DestroySurfaceOnDetach();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativePauseSurfaceRendering(JNIEnv *, jclass)
{
  g_framework->PauseSurfaceRendering();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeResumeSurfaceRendering(JNIEnv *, jclass)
{
  g_framework->ResumeSurfaceRendering();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeUpdateMyPositionRoutingOffset(JNIEnv * env, jclass clazz, int offsetY)
{
  g_framework->UpdateMyPositionRoutingOffset(offsetY);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeApplyWidgets(JNIEnv *, jclass)
{
  g_framework->ApplyWidgets();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeCleanWidgets(JNIEnv *, jclass)
{
  g_framework->CleanWidgets();
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeSetupWidget(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeCompassUpdated(JNIEnv *, jclass, jdouble north, jboolean forceRedraw)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeScalePlus(JNIEnv *, jclass)
{
  g_framework->Scale(::Framework::SCALE_MAG);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeScaleMinus(JNIEnv *, jclass)
{
  g_framework->Scale(::Framework::SCALE_MIN);
}

JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeOnScroll(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeOnScale(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeOnTouch(JNIEnv *, jclass, jint action,
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeStorageConnected(JNIEnv *, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_Map_nativeStorageDisconnected(JNIEnv *, jclass)
{
