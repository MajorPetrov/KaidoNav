...
extern "C"
{
  ...
  Java_app_kaidonav_sdk_search_SearchEngine_nativeInit(JNIEnv * env, jobject thiz)
  {
    ...
    g_updateResultsId = jni::GetMethodID(env, g_javaListener, "onResultsUpdate",
                                         "([Lapp/kaidonav/sdk/search/SearchResult;J)V");
    // public void onResultsEnd(long timestamp)
    g_endResultsId = jni::GetMethodID(env, g_javaListener, "onResultsEnd", "(J)V");
    g_resultClass = jni::GetGlobalClassRef(env, "app/kaidonav/sdk/search/SearchResult");
    g_resultConstructor = jni::GetConstructorID(
        env, g_resultClass,
        "(Ljava/lang/String;Lapp/kaidonav/sdk/search/SearchResult$Description;DD[I[I"
        "Lapp/kaidonav/sdk/search/Popularity;)V");
    g_suggestConstructor = jni::GetConstructorID(env, g_resultClass, "(Ljava/lang/String;Ljava/lang/String;DD[I[I)V");
    g_descriptionClass = jni::GetGlobalClassRef(env, "app/kaidonav/sdk/search/SearchResult$Description");
    /*
    ...
    */
    g_descriptionConstructor = jni::GetConstructorID(env, g_descriptionClass,
                                                     "(Lapp/kaidonav/bookmarks/data/FeatureId;"
                                                     "Ljava/lang/String;Ljava/lang/String;Lapp/kaidonav/util/Distance;"
                                                     "Ljava/lang/String;IIIZ)V");

    g_popularityClass = jni::GetGlobalClassRef(env, "app/kaidonav/sdk/search/Popularity");
    ...
    g_mapResultsMethod = jni::GetMethodID(env, g_javaListener, "onMapSearchResults",
                                          "([Lapp/kaidonav/sdk/search/MapSearchListener$Result;JZ)V");
    g_mapResultClass = jni::GetGlobalClassRef(env, "app/kaidonav/sdk/search/MapSearchListener$Result");
  ...
  JNIEXPORT jboolean JNICALL Java_app_kaidonav_sdk_search_SearchEngine_nativeRunSearch(
  ...
  JNIEXPORT void JNICALL Java_app_kaidonav_sdk_search_SearchEngine_nativeRunInteractiveSearch(
      JNIEnv * env, jclass clazz, jbyteArray bytes, jboolean isCategory,
  ...
  JNIEXPORT void JNICALL Java_app_kaidonav_sdk_search_SearchEngine_nativeRunSearchMaps(
  ...
  JNIEXPORT jboolean JNICALL Java_app_kaidonav_sdk_search_SearchEngine_nativeRunSearchInBookmarks(
  ...
  JNIEXPORT void JNICALL
  Java_app_kaidonav_sdk_search_SearchEngine_nativeShowResult(JNIEnv * env, jclass clazz, jint index)
  {
    g_framework->NativeFramework()->ShowSearchResult(g_results[index]);
  }

  JNIEXPORT void JNICALL
  Java_app_kaidonav_sdk_search_SearchEngine_nativeCancelInteractiveSearch(JNIEnv * env, jclass clazz)
  {
    g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Viewport);
  }

  JNIEXPORT void JNICALL
  Java_app_kaidonav_sdk_search_SearchEngine_nativeCancelEverywhereSearch(JNIEnv * env, jclass clazz)
  {
    g_framework->NativeFramework()->GetSearchAPI().CancelSearch(search::Mode::Everywhere);
  }

  JNIEXPORT void JNICALL
  Java_app_kaidonav_sdk_search_SearchEngine_nativeCancelAllSearches(JNIEnv * env, jclass clazz)
  {
