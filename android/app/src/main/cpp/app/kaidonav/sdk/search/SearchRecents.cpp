...
extern "C"
{
JNIEXPORT void JNICALL Java_app_kaidonav_sdk_search_SearchRecents_nativeGetList(JNIEnv * env, jclass, jobject result)
{
...
JNIEXPORT void JNICALL Java_app_kaidonav_sdk_search_SearchRecents_nativeAdd(JNIEnv * env, jclass, jstring locale,
                                                                               jstring query)
{
...
JNIEXPORT void JNICALL Java_app_kaidonav_sdk_search_SearchRecents_nativeClear(JNIEnv * env, jclass)
{
