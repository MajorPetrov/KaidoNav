...
Java_app_kaidonav_location_LocationState_nativeSwitchToNextMode(JNIEnv * env, jclass clazz)
{
  ASSERT(g_framework, ());
...
Java_app_kaidonav_location_LocationState_nativeGetMode(JNIEnv * env, jclass clazz)
{
  // GetMyPositionMode() is initialized only after drape creation.
  // https://github.com/kaidonav/kaidonav/issues/1128#issuecomment-1784435190
...
JNIEXPORT void JNICALL
Java_app_kaidonav_location_LocationState_nativeSetListener(JNIEnv * env, jclass clazz,
                                                                  jobject listener)
{
  ASSERT(g_framework, ());
...
JNIEXPORT void JNICALL
Java_app_kaidonav_location_LocationState_nativeRemoveListener(JNIEnv * env, jclass clazz)
{
  ASSERT(g_framework, ());
...
JNIEXPORT void JNICALL
Java_app_kaidonav_location_LocationState_nativeOnLocationError(JNIEnv * env, jclass clazz, int errorCode)
{
  ASSERT(g_framework, ());
...
JNIEXPORT void JNICALL
Java_app_kaidonav_location_LocationState_nativeLocationUpdated(JNIEnv * env, jclass clazz, jlong time,
