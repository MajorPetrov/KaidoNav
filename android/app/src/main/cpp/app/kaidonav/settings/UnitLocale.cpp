...
extern "C"
{
  ...
  Java_app_kaidonav_settings_UnitLocale_setCurrentUnits(JNIEnv * env, jobject thiz, jint units)
  {
  ...
  Java_app_kaidonav_settings_UnitLocale_getCurrentUnits(JNIEnv * env, jobject thiz)
  {
