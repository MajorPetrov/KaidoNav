...
Java_app_kaidonav_util_StringUtils_nativeIsHtml(JNIEnv * env, jclass thiz, jstring text)
{
  return strings::IsHTML(jni::ToNativeString(env, text));
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_util_StringUtils_nativeContainsNormalized(JNIEnv * env, jclass thiz, jstring str, jstring substr)
{
  return search::ContainsNormalized(jni::ToNativeString(env, str), jni::ToNativeString(env, substr));
}

JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_util_StringUtils_nativeFilterContainsNormalized(JNIEnv * env, jclass thiz, jobjectArray src, jstring jSubstr)
{
...
JNIEXPORT jint JNICALL Java_app_kaidonav_util_StringUtils_nativeFormatSpeed(
...
JNIEXPORT jobject JNICALL Java_app_kaidonav_util_StringUtils_nativeFormatSpeedAndUnits(
    JNIEnv * env, jclass thiz, jdouble metersPerSecond)
{
...
Java_app_kaidonav_util_StringUtils_nativeFormatDistance(JNIEnv * env, jclass, jdouble distanceInMeters)
{
  return ToJavaDistance(env, platform::Distance::CreateFormatted(distanceInMeters));
}

JNIEXPORT jobject JNICALL
Java_app_kaidonav_util_StringUtils_nativeGetLocalizedDistanceUnits(JNIEnv * env, jclass)
{
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_util_StringUtils_nativeGetLocalizedAltitudeUnits(JNIEnv * env, jclass)
{
...
Java_app_kaidonav_util_StringUtils_nativeGetLocalizedSpeedUnits(JNIEnv * env, jclass)
{
