...
void PrepareClassRefs(JNIEnv * env)
{
  ...
  g_bookmarkManagerClass =
    jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/BookmarkManager");
  g_bookmarkManagerInstanceField = jni::GetStaticFieldID(env, g_bookmarkManagerClass, "INSTANCE",
    "Lapp/kaidonav/bookmarks/data/BookmarkManager;");
  ...
  g_onPreparedFileForSharingMethod =
    jni::GetMethodID(env, bookmarkManagerInstance, "onPreparedFileForSharing",
                     "(Lapp/kaidonav/bookmarks/data/BookmarkSharingResult;)V");

  g_longClass = jni::GetGlobalClassRef(env,"java/lang/Long");
  g_longConstructor = jni::GetConstructorID(env, g_longClass, "(J)V");
  g_sortedBlockClass =
    jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/SortedBlock");
  ...
  g_onBookmarksSortingCompleted = jni::GetMethodID(env, bookmarkManagerInstance,
    "onBookmarksSortingCompleted", "([Lapp/kaidonav/bookmarks/data/SortedBlock;J)V");
  g_onBookmarksSortingCancelled = jni::GetMethodID(env, bookmarkManagerInstance,
    "onBookmarksSortingCancelled", "(J)V");
  g_bookmarkInfoClass =
    jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/BookmarkInfo");
  g_bookmarkInfoConstructor =
    jni::GetConstructorID(env, g_bookmarkInfoClass, "(JJ)V" );
  g_bookmarkCategoryClass =
    jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/BookmarkCategory");
...
{
  static jclass const classBookmarkSharingResult = jni::GetGlobalClassRef(env, "app/kaidonav/bookmarks/data/BookmarkSharingResult");
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeShowBookmarkOnMap(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeShowBookmarkCategoryOnMap(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeLoadBookmarks(JNIEnv * env, jclass)
{
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeCreateCategory(
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeDeleteCategory(
     JNIEnv *, jobject, jlong catId)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeDeleteBookmark(JNIEnv *, jobject, jlong bmkId)
{
  frm()->GetBookmarkManager().GetEditSession().DeleteBookmark(static_cast<kml::MarkId>(bmkId));
}

JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeDeleteTrack(
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeAddBookmarkToLastEditedCategory(
...
JNIEXPORT jlong JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetLastEditedCategory(
      JNIEnv *, jobject)
{
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetLastEditedColor(
        JNIEnv *, jobject)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeLoadBookmarksFile(JNIEnv * env, jclass,
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeIsAsyncBookmarksLoadingInProgress(JNIEnv *, jclass)
{
  return static_cast<jboolean>(frm()->GetBookmarkManager().IsAsyncLoadingInProgress());
}

JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeIsVisible(
    JNIEnv *, jobject, jlong catId)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetVisibility(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetCategoryName(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetCategoryDescription(JNIEnv * env,
                                                                                     jobject,
                                                                                     jlong catId,
                                                                                     jstring desc)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetCategoryTags(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetCategoryAccessRules(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetCategoryCustomProperty(
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeUpdateBookmarkPlacePage(
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkInfo(
  JNIEnv * env, jobject, jlong bmkId)
{
...
JNIEXPORT jlong JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkIdByPosition(
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetTrack(
      JNIEnv * env, jobject, jlong trackId, jclass trackClazz)
{
  ...
  static jmethodID const cId = jni::GetConstructorID(env, trackClazz,
                                                     "(JJLjava/lang/String;Lapp/kaidonav/util/Distance;I)V");
...
JNIEXPORT jlong JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetTrackIdByPosition(
        JNIEnv *, jobject, jlong catId, jint positionInCategory)
{
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeIsUsedCategoryName(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativePrepareForSearch(
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeAreAllCategoriesInvisible(
        JNIEnv *, jclass)
{
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeAreAllCategoriesVisible(
        JNIEnv *, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetAllCategoriesVisibility(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativePrepareTrackFileForSharing(JNIEnv * env, jclass, jlong trackId, jint kmlFileType)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativePrepareFileForSharing(JNIEnv * env, jclass, jlongArray catIds, jint kmlFileType)
{
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeIsCategoryEmpty(
        JNIEnv *, jclass, jlong catId)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetNotificationsEnabled(
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeAreNotificationsEnabled(
        JNIEnv *, jclass)
{
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkCategory(JNIEnv *env, jobject, jlong id)
{
  return MakeCategory(env, static_cast<kml::MarkGroupId>(id));
}

JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkCategories(JNIEnv *env, jobject)
{
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkCategoriesCount(JNIEnv *env, jobject)
{
   auto const & bm = frm()->GetBookmarkManager();
...
JNIEXPORT jobjectArray JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetChildrenCategories(JNIEnv *env, jobject, jlong parentId)
{
  auto const & bm = frm()->GetBookmarkManager();
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeHasLastSortingType(
    JNIEnv *, jobject, jlong catId)
{
  auto const & bm = frm()->GetBookmarkManager();
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetLastSortingType(
    JNIEnv *, jobject, jlong catId)
{
  auto const & bm = frm()->GetBookmarkManager();
  BookmarkManager::SortingType type;
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetLastSortingType(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeResetLastSortingType(
    JNIEnv *, jobject, jlong catId)
{
  auto & bm = frm()->GetBookmarkManager();
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetAvailableSortingTypes(JNIEnv *env,
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetSortedCategory(JNIEnv *env,
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkName(
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkFeatureType(
  JNIEnv * env, jclass, jlong bmk)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkDescription(
  JNIEnv * env, jclass, jlong bmk)
{
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkColor(
...
JNIEXPORT jint JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkIcon(
  JNIEnv *, jclass, jlong bmk)
{
  auto const * mark = getBookmark(bmk);
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetBookmarkParams(
  JNIEnv * env, jclass, jlong bmk,
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetTrackParams(
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetTrackDescription(
    JNIEnv * env, jclass, jlong trackId)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeChangeBookmarkCategory(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeChangeTrackCategory(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeChangeTrackColor(
...
JNIEXPORT jobject JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkXY(
  JNIEnv * env, jclass, jlong bmk)
{
...
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkScale(
  JNIEnv *, jclass, jlong bmk)
{
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeEncode2Ge0Url(
...
JNIEXPORT jstring JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetBookmarkAddress(
...
JNIEXPORT jdouble JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetElevationCurPositionDistance(
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetElevationCurrentPositionChangedListener(
        JNIEnv * env, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeRemoveElevationCurrentPositionChangedListener(
        JNIEnv *, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetElevationActivePoint(
...
JNIEXPORT jdouble JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeGetElevationActivePointDistance(
  JNIEnv *, jclass, jlong trackId)
{
  auto & bm = frm()->GetBookmarkManager();
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeSetElevationActiveChangedListener(
   JNIEnv *env, jclass)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_bookmarks_data_BookmarkManager_nativeRemoveElevationActiveChangedListener(
        JNIEnv *, jclass)
{
...
JNIEXPORT jboolean JNICALL
Java_app_kaidonav_widget_placepage_PlacePageButtonFactory_nativeHasRecentlyDeletedBookmark(JNIEnv *, jclass)
{
