...
Java_app_kaidonav_maplayer_traffic_TrafficState_nativeSetListener(JNIEnv * env, jclass clazz, jobject listener)
{
...
JNIEXPORT void JNICALL
Java_app_kaidonav_maplayer_traffic_TrafficState_nativeRemoveListener(JNIEnv * env, jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
JNIEXPORT void JNICALL
Java_app_kaidonav_maplayer_traffic_TrafficState_nativeEnable(JNIEnv * env, jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
Java_app_kaidonav_maplayer_traffic_TrafficState_nativeIsEnabled(JNIEnv * env, jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
...
JNIEXPORT void JNICALL
Java_app_kaidonav_maplayer_traffic_TrafficState_nativeDisable(JNIEnv * env, jclass clazz)
{
  CHECK(g_framework, ("Framework isn't created yet!"));
